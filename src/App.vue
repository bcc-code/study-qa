...
const queryParamWeek = new URLSearchParams(window.location.search).get("week");
...
<template>
  <div
    class="w-screen h-screen bg-white overflow-x-hidden overflow-y-scroll flex items-stretch flex-col"
  >
    <div
